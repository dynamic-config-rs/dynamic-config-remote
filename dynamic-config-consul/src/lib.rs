...
//! [`reporting_to`](Consul::reporting_to) is what lets it speak: the sink the
...
impl Consul {
    ...
    {
        // Returned and recorded nowhere, all three of them: nothing has been
        // asked of the agent yet, and `reachable()` is *whether the store
        // answered the last time it was asked*. See the table in this crate's
        // documentation for where that line falls.
